...
A basic, sample app is available in [the `example` folder](https://github.com/vaporjawn/react-native-image-resizer/tree/master/example). It uses the module to resize a photo from the Camera Roll.
